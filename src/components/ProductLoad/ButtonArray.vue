<template>
    <div class="d-flex">
        ...
        <v-btn class="mr-3" color="primary">Upload <v-icon :icon="mdiUpload" end></v-icon></v-btn>
        <v-btn class="mr-3" color="primary">Download <v-icon :icon="mdiDownload" end></v-icon></v-btn>
